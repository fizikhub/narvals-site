...
export const staticPages = [
  ...
  { key: 'ecommerce', path: '/hizmetler/e-ticaret/', file: 'hizmetler/e-ticaret/index.html', lastModified: '2026-08-30', kind: 'service' },
  ...
  { key: 'meta-ads', path: '/hizmetler/dijital-reklam/', file: 'hizmetler/dijital-reklam/index.html', lastModified: '2026-08-30', kind: 'service' },
  { key: 'google-ads', path: '/hizmetler/google-ads/', file: 'hizmetler/google-ads/index.html', lastModified: '2026-08-30', kind: 'service' },
  ...
  { key: 'contact', path: '/iletisim/', file: 'iletisim/index.html', lastModified: '2026-08-30', kind: 'contact' },
  { key: 'privacy', path: '/gizlilik/', file: 'gizlilik/index.html', lastModified: '2026-08-30', kind: 'policy' },
