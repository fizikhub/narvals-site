export const topicHubs = [
  {
    slug: 'e-ticaret',
    title: 'E-ticaret rehberleri: fikirden çalışan mağazaya',
    metaTitle: 'E-Ticaret Sitesi Kurma ve Büyütme Rehberleri | Narvals',
    description: 'E-ticaret sitesi açma, altyapı seçme, maliyet, dönüşüm, teknik SEO ve özel yazılım kararlarını doğru sırayla ele alan rehber merkezi.',
  ...
  {
    slug: 'web-sitesi',
    title: 'Web sitesi rehberleri: kapsamdan yayına',
    metaTitle: 'Web Sitesi Kurma, Fiyat ve Teknik SEO Rehberleri | Narvals',
    description: 'İnternet sitesi kurma, brief hazırlama, proje süresi, maliyet, B2B yapı, hız ve teknik SEO kararlarını bir araya getiren rehber merkezi.',
  ...
  {
    slug: 'reklam',
    title: 'Dijital reklam rehberleri: bütçeden gerçek sonuca',
    metaTitle: 'Google Ads ve Meta Reklam Rehberleri | Narvals Labs',
    description: 'Google Ads ve Meta reklam bütçesi, kanal seçimi, ajans değerlendirme, ölçüm ve açılış sayfası kararlarını doğru sıraya koyan rehber merkezi.',
    ...
    all: ['google-ads-reklami-yaptirmak-isteyenler-icin-rehber', 'google-ads-kalite-puani-ve-negatif-kelime-rehberi', 'google-ads-arama-terimleri-ve-butce-optimizasyonu', 'meta-reklami-hizmeti-almak-isteyenler-icin-rehber', 'meta-reklamlarinda-kreatif-ve-kanca-stratejisi', 'meta-reklam-metni-ve-reklam-yazarligi-rehberi', 'google-ads-reklam-nasil-verilir', 'google-ads-butcesi-nasil-belirlenir', 'google-ads-ajansi-ucretleri-ve-yonetim-modelleri', 'google-ads-mi-meta-reklamlari-mi', 'google-ads-ajansi-secerken-sorulacak-sorular', 'meta-reklam-butcesi-nasil-belirlenir', 'meta-reklam-ajansi-ucretleri-ve-yonetim-modelleri', 'meta-reklam-ajansi-secerken-sorulacak-sorular', 'meta-pixel-ve-conversions-api-farki', 'ga4-ve-server-side-gtm-kurulum-rehberi', 'sosyal-medya-yonetimi-neleri-kapsar'],
    servicePath: '/hizmetler/google-ads/', serviceLabel: 'Google Ads hizmetini inceleyin'
  },
  {
    slug: 'qr-menu',
    title: 'QR menü rehberleri: masadaki koddan operasyona',
    metaTitle: 'QR Menü Kurma, Fiyat ve Sistem Seçme Rehberleri | Narvals',
    description: 'QR menü yapma, fiyat ve kapsam karşılaştırma, PDF farkı, restoran web sitesi ve rezervasyon sistemi kararları için rehber merkezi.',
    keywords: ['QR menü rehberi', 'QR menü fiyatları', 'dijital menü', 'restoran QR menü'],
    answer: 'QR menüyü yalnız kod üretme işi olarak görmeyin. Menü verisi, mobil kullanım, güncelleme, fiyat, dil, şube ve gerekiyorsa rezervasyon aynı işletme akışında değerlendirilmelidir.',
  ...
  },
  {
    ...
    start: ['google-ve-ai-botlari-icin-site-indeksleme-rehberi', 'crawl-budget-ve-googlebot-tarama-verimliligi', 'schema-org-ve-baglantili-jsonld-graflari'],
    all: ['webmcp-ai-ajanlari-icin-web-sitesi-rehberi', 'google-ve-ai-botlari-icin-site-indeksleme-rehberi', 'crawl-budget-ve-googlebot-tarama-verimliligi', 'google-ai-aramalari-icin-geo-rehberi', 'schema-org-ve-baglantili-jsonld-graflari', 'e-e-a-t-yazar-otoritesi-ve-google-guven-rehberi', 'ga4-ve-server-side-gtm-kurulum-rehberi', 'web-sitesi-teknik-seo-kontrol-listesi', 'web-sitesi-hizlandirma-core-web-vitals-rehberi', 'web-sitesi-googleda-neden-cikmiyor', 'web-sitesi-donusum-orani-nasil-hesaplanir'],
